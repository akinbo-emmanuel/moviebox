            ...
            >
              <div className='relative'>
                ...
                <div className='absolute top-2 right-2'>
                  <FaHeart
                    className='text-gray-300 bg-[#F3F4F6] rounded-full p-2 cursor-pointer duration-300 hover:scale-110'
                    size={33}
                  />
                </div>
              </div>
              <div>
                <p
                  ...
                  className='text-[1rem] text-gray-400 font-sans py-2'
                >
                  {movie.release_date}
                </p>
                <h1
                  data-testid='movie-title'
                  className='text-gray-900 text-[1.3rem] font-semibold'
                >
                ...
                <p className='flex items-center text-[1rem] text-gray-400 font-sans py-1'>
                  <MdLanguage className='text-rose-500 mr-2' size={25} />
